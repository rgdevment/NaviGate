...
LinkUnbound Individual Contributor License Agreement, version 1.0.
...
separate commercial terms to organisations that cannot comply with the GPL.
Offering those commercial terms requires the right to license the whole
...
- The community edition of LinkUnbound stays available under the GPL-3.0.
...
You can still use LinkUnbound, report bugs, request features, help with
translations feedback, discuss design, and fork the project under the
GPL-3.0. Only merging code into this repository requires the agreement.
